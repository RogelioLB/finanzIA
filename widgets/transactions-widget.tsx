...
export default function TransactionsWidget() {
  const { recentTransactions, loading, formatAmount, formatDate } = useTransactions();
            ...
            >
              ...
              >
                <View style={styles.transactionLeft}>
                  <View style={[
                    styles.categoryIcon,
                    { backgroundColor: transaction.category_color || '#F0F0F0' }
                  ]}>
                ...
                <View style={styles.transactionRight}>
                  <Text style={[
                    ...
                    { color: transaction.type === 'expense' ? '#FF4757' : '#2ED573' }
                  ]}>
